...
try:
    ...
    data = np.loadtxt('data/data_-10db_snr.txt', dtype='float32')

    data0 = windowing(data)

    fft_data0 = fft0(data0)

    ave_fft0 = ave_fft0(fft_data0) - cal_ave
